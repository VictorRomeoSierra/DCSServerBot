...
from .listener import VRSPersistencyLibraryEventListener


class VRSPersistencyLibrary(Plugin):
    """
...
async def setup(bot: DCSServerBot):
    await bot.add_cog(VRSPersistencyLibrary(bot, VRSPersistencyLibraryEventListener))
